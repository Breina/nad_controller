...
client = NadClient("192.168.1.110")
print(client.get_device_name())
# print(client.get_device_model())
# print(client.get_installation_date())
# print(client.get_serial_number())
# client.set_ip_address("192.168.1.110")
# client.set_subnet_mask("255.255.255.0")
# print(client.set_global_control(GlobalInput.GLOBAL_1, False))
# print(client.set_input_gain(1, 0))
# print(client.set_output_gain(1, 3.5))
# print(client.get_output_gain(1))
# print(client.set_output_source(1, 5))
# print(client.set_stereo_mono(2, StereoMono.STEREO))
# print(client.set_output_mute(1, False))
# print(client.get_output_mute(1))
# print(client.set_output_preset(1))
# print(client.set_power_method(PowerMethod.POWER_BUTTON))
# print(client.set_green_mode(False))
# print(client.set_delay_time(0))
# print(client.reset())
# print(client.power_on())
# print(client.power_off())
# print(client.power_toggle())
# print(client.query_power_status())

# Cmd:Source1     , Group:A
# print(client.test_command("FF5502090001"))

# Cmd:MuteOff     , Group:A
# print(client.test_command("FF55020800"))

# Cmd:MuteOff     , Group:A
# print(client.test_command("FF55020700"))

# Cmd:MuteToggle  , Group:A
# print(client.test_command("FF55020600"))

print(client.test_command("FF55021800"))